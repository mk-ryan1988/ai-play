  ...
  return (
    <div className="space-y-8 p-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-secondary text-title border border-tertiary rounded-lg hover:bg-tertiary transition-colors"
          >
            Update Background
          </button>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-secondary border border-tertiary rounded-lg">
        ...
        <div className="p-4 bg-secondary border border-tertiary rounded-lg space-y-3">
          ...
          >
            <input
              ...
              className="flex-1 px-3 py-2 bg-tertiary text-body rounded-lg border border-tertiary focus:outline-none focus:ring-2 focus:ring-accent"
            />
            <button
              type="submit"
              className="px-4 py-2 bg-accent text-accent-text rounded-lg hover:bg-accent-hover transition-colors whitespace-nowrap"
            >
              Generate Theme
            </button>
          </form>
